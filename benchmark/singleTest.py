...
def suite():
    ...
    #s.addTest(TensorTest("test_vec_grad_lin"))
   ...
   #  s.addTest(TensorTest("test_Tensor_initialization"))
    ...
    s.addTest(TensorTest("test_ChangeOfBase"))
  #  s.addTest(TensorTest("test_transform2_secondOrderTensors"))
  #  s.addTest(TensorTest("test_extract_keys"))
  #  s.addTest(TensorTest("test_CoordsTransformNew"))
    #s.addTest(TensorTest("test_transform2_secondOrderTensors"))
